...
simulacion_ej3 = function(p1,p3){
  ...
  g = sample_degseq(out.deg = v, method = "simple")
...
```{r}
Avg_largest_l = c()
for(p1 in seq(from=0, to=1, by=0.05)){
  p3 = 1 - p1
...
```{r}
plot(x=seq(from=0, to=1, by=0.01), y=Avg_largest_l,pch=19,col="red",type="b",ylab="Tamaño de componente", xlab="Valor de p1")
```
