...
<ul>
<li>Se podría intuir que los 10 nodos de más grado son los 10 nodos iniciales, ya que todos los demás nodos provienen de estos iniciales, pero con la posibilidad de tener uniones entre los demás nodos también, no se puede asegurar que los 10 nodos de más grado son los nodos iniciales.</li>
<li>Se podrían analizar todos los recorridos en el grafo (de todos los nodos a todos los nodos), y se podría afirmar que los 10 nodos iniciales están en al menos uno de los recorridos entre dos nodos cualquieras. Pero, igual que antes, con la posibilidad de que los demás nodos pueden tener uniones entre si también, esta afirmación también se podría cumplir con otro nodo que no es de los 10 iniciales.</li>
</ul>
