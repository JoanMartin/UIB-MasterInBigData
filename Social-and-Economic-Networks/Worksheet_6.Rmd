...
Closeness In y Closeness Out, que se han calculado como $\omega(e) = 1 / \omega(e)$ debido a que los pesos no indican distancia, muestran los países que importan y exportan, respectivamente, menos petróleo o tienen pocas conexiones.
...
Consideramos el 5% de nodos más importantes aquellos que exportan una mayor cantidad de petróleo, ya que Strength Out tiene en cuenta los grados y el peso de las aristas. De esta forma podríamos examinar, por ejemplo, por qué a un país le compran tanto petróleo (precios más baratos, fronteras más abiertas, etc.).
