...
Consideramos el 5% de nodos más importantes aquellos que envían petróleo a una mayor cantidad de países, por esta razón utilizamos el out-strength. De esta forma podríamos examinar (independientemente de la cantidad de petróleo que se envíe) por qué a un país le compran tanto petróleo (precios más baratos, fronteras más abiertas, etc.).
...
Elegimos la centralidad out-strength para representar el tamaño de los nodos por el motivo explicado en el apartado anterior. De esta forma podremos analizar gráficamente qué países exportan petróleo a una mayor cantidad de países.
