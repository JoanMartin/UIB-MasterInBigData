...
```{r}
summary_g=as.network(as.matrix(as_adjacency_matrix(g)),directed=FALSE)
summary_g
```
...
Betweeness. Simplemente la ciudad por donde tienen que pasar más para llegar a esta misma ciudad o a las demas ciudades conectadas a esta más central.
...
Barabasi. Si hay nodos con aristas en las dos direcciones, no serÃ¡ compatible...?
