...
**Analizamos 3 variables con la matriz de correlación dada por**
...
No tiene sentido hacer un análisis de componentes principales porque las variables no están nada correlacionadas entre sí y el número de componentes que saldrían sería el mismo que el número de variables que tenemos.

<br>

(b) **¿Cuántos componentes principales crees que encontramos (elegimos)?**

Encontraríamos 3 componentes principales, que es el mismo número de variables que tenemos. Dado que no están nada correlacionadas, elegir un número de componentes menor que 3 resultaría en una pérdida de información muy grande.

<br>

(c) **¿Qué porcentaje de la varianza total explica aproximadamente cada componente principal?** 

Cada componente principal explicaría alrededor de un $1/3$ de varianza por lo explicado en los apartados a) y b).
