...
a:link {color: #0174DF;}
div pre { background-color:#E0ECF8;}
body { background-color: #f6f7fd; }, td { font-size: 11.5pt; } code.r{ font-size: 14px; } pre { font-size: 14px }
...
setwd("C:/Users/maria/Documents/UIB/MADM/1rSemestre/AprenentatgeEstadisticPresaDecisions/Full2")
#setwd("C:/Users/Christian/Documents/Master/Aprendizaje Estadistico y Toma de Decisiones/Practica 2")
```
